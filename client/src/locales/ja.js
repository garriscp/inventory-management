export default {
  ...
  restocking: {
    title: '補充発注',
    description: '需要予測に基づく補充推奨',
    budgetTitle: '利用可能予算',
    recommendationsTitle: '推奨品目',
    noRecommendations: '増加傾向の品目が見つかりません。',
    table: {
      sku: 'SKU',
      itemName: '品目名',
      demandGap: '需要ギャップ',
    ...
    selectedSummary: '{count}件選択中 — 合計: {cost}',
    placeOrder: '発注する',
    placing: '発注中...',
    orderSubmitted: '発注が完了しました',
    orderNumber: '注文番号',
  ...
  orders: {
    ...
    allOrders: 'すべての注文',
    submittedRestocking: '補充発注履歴',
    inSession: '今回のセッションのみ',
    totalOrders: '総注文数',
    totalRevenue: '総収益',
    avgOrderValue: '平均注文額',
    onTimeDelivery: '定時配達',
